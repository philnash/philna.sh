/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 03b4669f55b888870929e20306e0508a)
// Runtime types generated with workerd@1.20260811.1 2026-03-22 nodejs_compat
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	OPENAI_API_KEY: string;
	ASTRADB_APP_TOKEN: string;
	ASTRADB_ENDPOINT: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "OPENAI_API_KEY" | "ASTRADB_APP_TOKEN" | "ASTRADB_ENDPOINT" | "RESEND_API_KEY" | "RESEND_TO_EMAIL" | "RESEND_FROM_EMAIL" | "RESEND_SEGMENT_ID" | "CLOUDFLARE_SITE_KEY" | "CLOUDFLARE_SECRET_KEY">> {}
}
